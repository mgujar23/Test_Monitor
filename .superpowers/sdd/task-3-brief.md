...
**Goal:** Create project directory structure and comprehensive README documentation.
...
Use: `mkdir -p src/api src/server src/ui/components src/ui/pages src/ui/utils src/ui/styles public cache logs`

### File: README.md
Complete content below - match exactly:
...
1. Create all directories: `mkdir -p src/api src/server src/ui/components src/ui/pages src/ui/utils src/ui/styles public cache logs`
2. Create README.md with exact content above
3. Commit with message: "docs: add README with setup instructions"

## Verification

- ✓ All directories created
- ✓ README.md created with exact content
- ✓ Committed to git
